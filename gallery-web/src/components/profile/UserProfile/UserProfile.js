      ...
      <div className={cx('profile-info')}>
              ...
              profile.toJS().is_self ? (
                ...
                profile.toJS().following ? (
                  <Button onClick={onUnfollowUser} theme="unfollow">언팔로우</Button>
                    ...
                    <Button onClick={onFollowUser} theme="follow">팔로우</Button>
                  )
            }
          </div>
          {
        ...
        <div className={cx('description')}>
          <div className={cx('counts')}>
            게시물 &nbsp; <div className={cx('count-text')}>{profile.toJS().post_count}</div>
          </div>
          <div className={cx('counts')} onClick={showFollowModal}>
            팔로워 &nbsp; <div className={cx('count-text')}>{profile.toJS().followers_count}</div>
          </div>
          <div className={cx('counts')} onClick={showFollowingModal}>
            팔로잉 &nbsp; <div className={cx('count-text')}>{profile.toJS().following_count}</div>
          </div>
        </div>
      </div>
    </div>
